...
//                    row.performanceValidationIssued,
    ...
    private val utcResetActions: List<() -> Unit> = listOf(
        ...
        { setSmeName("") },
        { setSmeEngineerNotes("") },
//        { setSensitivityCompliance(YesNoState.NO) },
//        { setEssentialRequirementCompliance(YesNoState.NO)},
//        { setFailsafeCompliance(YesNoState.NO) },
//        { setBestSensitivityCompliance(YesNoState.NO) },
//        { setSensitivityRecommendations("") },
//        { setPerformanceValidationIssued(YesNoState.NO) },
//        { setDetectionSetting1label("") },
//        { setDetectionSetting2label("") },
//        { setDetectionSetting3label("") },
//        { setDetectionSetting4label("") },
//        { setDetectionSetting5label("") },
//        { setDetectionSetting6label("") },
//        { setDetectionSetting7label("") },
//        { setDetectionSetting8label("") },
