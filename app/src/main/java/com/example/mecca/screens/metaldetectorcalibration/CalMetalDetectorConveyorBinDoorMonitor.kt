    ...
    Column(
        ...
        if (binDoorMonitorFitted == YesNoState.YES) {
            ...
            LabeledMultiSelectDropdownWithHelp(
                ...
                onSelectionChange = { newSelectedOptions -> viewModel.setBinDoorOpenIndication(newSelectedOptions) },
            ...
            LabeledMultiSelectDropdownWithHelp(
                ...
                onSelectionChange = { newSelectedOptions -> viewModel.setBinDoorUnlockedIndication(newSelectedOptions) },
                helpText = "Select one or more items from the dropdown.",
                isNAToggleEnabled = false
            )
            ...
            LabeledMultiSelectDropdownWithHelp(
                ...
                onSelectionChange = { newSelectedOptions -> viewModel.setBinDoorTimeoutResult(newSelectedOptions) },
