...
fun CalMetalDetectorConveyorSummaryDetails(
    ...
    Column(
        ...
        Section(title = "Detection Settings (As Found)") {
            SummaryItem(label = "Sensitivity Access Restriction", value = viewModel.sensitivityAccessRestriction.value)
        ...
        Section(title = "Ferrous Sensitivity (As Left)") {
            ...
            SummaryItem(label = "Detect/Reject Leading", value = viewModel.detectRejectFerrousLeading.value.toString())
            SummaryItem(label = "Detect/Reject Middle", value = viewModel.detectRejectFerrousMiddle.value.toString())
            SummaryItem(label = "Detect/Reject Trailing", value = viewModel.detectRejectFerrousTrailing.value.toString())
        ...
        Section(title = "Retailer Compliance Confirmation") {
            SummaryItem(label = "Sensitivity Compliance", value = viewModel.sensitivityCompliance.value.toString())
            SummaryItem(label = "Essential Compliance", value = viewModel.essentialRequirementCompliance.value.toString())
            SummaryItem(label = "Failsafe Compliance", value = viewModel.failsafeCompliance.value.toString())
            SummaryItem(label = "Best Sensitivity Report", value = viewModel.bestSensitivityCompliance.value.toString())
            SummaryItem(label = "Sensitivity Recommendations", value = viewModel.sensitivityRecommendations.value)
