...
class MetalDetectorConveyorCalibrationRepository(private val calibrationDao: MetalDetectorConveyorCalibrationDAO) {
    ...
    suspend fun createCsvFile(context: Context, calibrationId: String): File? = withContext(Dispatchers.IO) {
        ...
        try {
            val rawData = listOf(
                ...
                "${row.indicator3colour} (${row.indicator3label})".trim(),
                ...
                row.operatorTestWitnessedBinDoor,
                row.operatorTestWitnessedAirFail,
    ...
    suspend fun updateOperatorTest(update: OperatorTestUpdate) {
        calibrationDao.updateOperatorTest(
            ...
            operatorTestWitnessedInfeed = update.operatorTestWitnessedInfeed,
            operatorTestWitnessedRejectConfirm = update.operatorTestWitnessedRejectConfirm,
            operatorTestWitnessedBinFull = update.operatorTestWitnessedBinFull,
            operatorTestWitnessedBinDoor = update.operatorTestWitnessedBinDoor,
            operatorTestWitnessedAirFail = update.operatorTestWitnessedAirFail,
            operatorTestWitnessedPackCheck = update.operatorTestWitnessedPackCheck,
            operatorTestWitnessedSpeedSensor = update.operatorTestWitnessedSpeedSensor,
            operatorTestWitnessedBackup = update.operatorTestWitnessedBackup,
