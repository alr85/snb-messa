...
//    fun getCompletedCalibrations(systemId: Int): Flow<List<MetalDetectorConveyorCalibrationLocal>>
    ...
    @Query(
        "UPDATE MetalDetectorConveyorCalibrations " +
                ...
                "peakSignalAsFoundFerrousLeading = :peakSignalAsFoundFerrousLeading," +
                "detectRejectAsFoundFerrousMiddle = :detectRejectAsFoundFerrousMiddle," +
                "peakSignalAsFoundFerrousMiddle = :peakSignalAsFoundFerrousMiddle, " +
                "detectRejectAsFoundFerrousTrailing = :detectRejectAsFoundFerrousTrailing," +
                "peakSignalAsFoundFerrousTrailing = :peakSignalAsFoundFerrousTrailing," +
    ...
    suspend fun updateFerrousAsFound(
        ...
        peakSignalAsFoundFerrousLeading: String,
        detectRejectAsFoundFerrousMiddle: String,
        peakSignalAsFoundFerrousMiddle: String,
        detectRejectAsFoundFerrousTrailing: String,
        peakSignalAsFoundFerrousTrailing: String,
    ...
    @Query(
        "UPDATE MetalDetectorConveyorCalibrations " +
                ...
                "peakSignalAsFoundNonFerrousLeading = :peakSignalAsFoundNonFerrousLeading," +
                "detectRejectAsFoundNonFerrousMiddle = :detectRejectAsFoundNonFerrousMiddle," +
                "peakSignalAsFoundNonFerrousMiddle = :peakSignalAsFoundNonFerrousMiddle, " +
                "detectRejectAsFoundNonFerrousTrailing = :detectRejectAsFoundNonFerrousTrailing," +
                "peakSignalAsFoundNonFerrousTrailing = :peakSignalAsFoundNonFerrousTrailing," +
    ...
    suspend fun updateNonFerrousAsFound(
        ...
        peakSignalAsFoundNonFerrousLeading: String,
        detectRejectAsFoundNonFerrousMiddle: String,
        peakSignalAsFoundNonFerrousMiddle: String,
        detectRejectAsFoundNonFerrousTrailing: String,
        peakSignalAsFoundNonFerrousTrailing: String,
    ...
    @Query(
        "UPDATE MetalDetectorConveyorCalibrations " +
                ...
                "peakSignalAsFoundStainlessLeading = :peakSignalAsFoundStainlessLeading," +
                "detectRejectAsFoundStainlessMiddle = :detectRejectAsFoundStainlessMiddle," +
                "peakSignalAsFoundStainlessMiddle = :peakSignalAsFoundStainlessMiddle, " +
                "detectRejectAsFoundStainlessTrailing = :detectRejectAsFoundStainlessTrailing," +
                "peakSignalAsFoundStainlessTrailing = :peakSignalAsFoundStainlessTrailing," +
    ...
    suspend fun updateStainlessAsFound(
        ...
        peakSignalAsFoundStainlessLeading: String,
        detectRejectAsFoundStainlessMiddle: String,
        peakSignalAsFoundStainlessMiddle: String,
        detectRejectAsFoundStainlessTrailing: String,
        peakSignalAsFoundStainlessTrailing: String,
    ...
    @Query(
        "UPDATE MetalDetectorConveyorCalibrations " +
                ...
                "productPeakSignalAsLeft = :productPeakSignalAsLeft," +
    ...
    suspend fun updateDetectionSettingAsLeft(
        ...
        productPeakSignalAsLeft: String,
