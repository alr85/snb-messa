...
data class DetectionSettingAsLeftUpdate(
    ...
    val productPeakSignalAsLeft: String,
    val calibrationId: String
)
...
fun CalibrationMetalDetectorConveyorViewModel.toDetectionSettingAsLeftUpdate()
    ...
    return DetectionSettingAsLeftUpdate(
        ...
        productPeakSignalAsLeft = productPeakSignalAsLeft.value,
        calibrationId = calibrationId.value
    )
}
...
data class OperatorTestUpdate(
    ...
    val smeName: String,
    val operatorTestWitnessedInfeed: String,
    val operatorTestWitnessedRejectConfirm: String,
    val operatorTestWitnessedBinFull: String,
    val operatorTestWitnessedBinDoor: String,
    val operatorTestWitnessedAirFail: String,
    val operatorTestWitnessedPackCheck: String,
    val operatorTestWitnessedSpeedSensor: String,
    val operatorTestWitnessedBackup: String,
...
fun CalibrationMetalDetectorConveyorViewModel.toOperatorTestUpdate(): OperatorTestUpdate {
    return OperatorTestUpdate(
        ...
        operatorTestWitnessedInfeed = operatorTestWitnessedInfeed.value.toString(),
        operatorTestWitnessedRejectConfirm = operatorTestWitnessedRejectConfirm.value.toString(),
        operatorTestWitnessedBinFull = operatorTestWitnessedBinFull.value.toString(),
        operatorTestWitnessedBinDoor = operatorTestWitnessedBinDoor.value.toString(),
        operatorTestWitnessedAirFail = operatorTestWitnessedAirFail.value.toString(),
        operatorTestWitnessedPackCheck = operatorTestWitnessedPackCheck.value.toString(),
        operatorTestWitnessedSpeedSensor = operatorTestWitnessedSpeedSensor.value.toString(),
        operatorTestWitnessedBackup = operatorTestWitnessedBackup.value.toString(),
