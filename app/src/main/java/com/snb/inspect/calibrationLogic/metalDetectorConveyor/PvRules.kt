...
fun CalibrationMetalDetectorConveyorViewModel.getBinDoorMonitorPvRules(): List<PvRule> {
    ...
    val timeoutResultsStatus = when {
        ...
        timeoutResults.any { it.contains("Indicator", ignoreCase = true) || it.contains("Notification", ignoreCase = true) } && "System Belt Stops" in timeoutResults -> PvRuleStatus.Pass
