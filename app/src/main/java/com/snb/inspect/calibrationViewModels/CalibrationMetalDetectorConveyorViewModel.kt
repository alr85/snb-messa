...
//import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toComplianceConfirmationUpdate
...
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toBinDoorMonitorUpdate
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toBinFullSensorUpdate
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toCalibrationEndUpdate
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toCalibrationStartUpdate
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toConveyorDetailsUpdate
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toDetectNotificationUpdate
...
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toInfeedSensorUpdate
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toLargeMetalResultUpdate
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toNewCalibrationInsert
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toNonFerrousAsFoundUpdate
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toNonFerrousResultUpdate
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toOperatorTestUpdate
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toPackCheckSensorUpdate
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toProductDetailsUpdate
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toRejectConfirmSensorUpdate
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toRejectSettingsUpdate
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toSensitivitiesAsFoundUpdate
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toSensitivityRequirementsUpdate
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toSpeedSensorUpdate
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toStainlessAsFoundUpdate
import com.snb.inspect.calibrationLogic.metalDetectorConveyor.toStainlessResultUpdate
        ...
        viewModelScope.launch {
            ...
            if (existingCalibration != null) {
                ...
                _peakSignalAsFoundFerrousLeading.value =
                        existingCalibration.peakSignalAsFoundFerrousLeading
                ...
                _peakSignalAsFoundFerrousMiddle.value =
                    existingCalibration.peakSignalAsFoundFerrousMiddle
                ...
                _peakSignalAsFoundFerrousTrailing.value =
                    existingCalibration.peakSignalAsFoundFerrousTrailing
                ...
                _peakSignalAsFoundNonFerrousLeading.value =
                    existingCalibration.peakSignalAsFoundNonFerrousLeading
                ...
                _peakSignalAsFoundNonFerrousMiddle.value =
                    existingCalibration.peakSignalAsFoundNonFerrousMiddle
                ...
                _peakSignalAsFoundNonFerrousTrailing.value =
                    existingCalibration.peakSignalAsFoundNonFerrousTrailing
                ...
                _peakSignalAsFoundStainlessLeading.value =
                    existingCalibration.peakSignalAsFoundStainlessLeading
                ...
                _peakSignalAsFoundStainlessMiddle.value =
                    existingCalibration.peakSignalAsFoundStainlessMiddle
                ...
                _peakSignalAsFoundStainlessTrailing.value =
                    existingCalibration.peakSignalAsFoundStainlessTrailing
...
//------------------------------------------------------------------Non Ferrous Sensitivity As Found
    ...
    private val _productPeakSignalAsLeft = mutableStateOf("")
    val productPeakSignalAsLeft: State<String> = _productPeakSignalAsLeft


    fun setProductPeakSignalAsLeft(newProductPeakSignalAsLeft: String) {
        _productPeakSignalAsLeft.value = newProductPeakSignalAsLeft
    }
...
//    }
    ...
    private val utcResetActions: List<() -> Unit> = listOf(
        ...
        { setProductWidth("") },
        { setProductHeight("") },
        { setProductDetailsEngineerNotes("") },
        { setDetectionSettingAsFound1("") },
        { setDetectionSettingAsFound2("") },
        { setDetectionSettingAsFound3("") },
        { setDetectionSettingAsFound4("") },
        { setDetectionSettingAsFound5("") },
        { setDetectionSettingAsFound6("") },
        { setDetectionSettingAsFound7("") },
        { setDetectionSettingAsFound8("") },
        { setDetectionSettingAsFoundEngineerNotes("") },
        { setSensitivityRequirementFerrous("") },
        { setSensitivityRequirementNonFerrous("") },
        ...
        { setSampleCertificateNumberFerrous("") },
        { setDetectRejectFerrousLeading(YesNoState.NA) },
        { setPeakSignalFerrousLeading("") },
        { setDetectRejectFerrousMiddle(YesNoState.NA) },
        { setPeakSignalFerrousMiddle("") },
        { setDetectRejectFerrousTrailing(YesNoState.NA) },
        { setPeakSignalFerrousTrailing("") },
        { setFerrousTestEngineerNotes("") },
        { setSensitivityAsLeftNonFerrous("") },
        { setSampleCertificateNumberNonFerrous("") },
        { setDetectRejectNonFerrousLeading(YesNoState.NA) },
        { setPeakSignalNonFerrousLeading("") },
        { setDetectRejectNonFerrousMiddle(YesNoState.NA) },
        { setPeakSignalNonFerrousMiddle("") },
        { setDetectRejectNonFerrousTrailing(YesNoState.NA) },
        { setPeakSignalNonFerrousTrailing("") },
        { setNonFerrousTestEngineerNotes("") },
        { setSensitivityAsLeftStainless("") },
        { setSampleCertificateNumberStainless("") },
        { setDetectRejectStainlessLeading(YesNoState.NA) },
        { setPeakSignalStainlessLeading("") },
        { setDetectRejectStainlessMiddle(YesNoState.NA) },
        { setPeakSignalStainlessMiddle("") },
        { setDetectRejectStainlessTrailing(YesNoState.NA) },
        { setPeakSignalStainlessTrailing("") },
        { setStainlessTestEngineerNotes("") },
        ...
        { setDetectionSettingAsLeft4("") },
        { setDetectionSettingAsLeft5("") },
        { setDetectionSettingAsLeft6("") },
        { setDetectionSettingAsLeft7("") },
        { setDetectionSettingAsLeft8("") },
        { setDetectionSettingAsLeftEngineerNotes("") },
        { setRejectSynchronisationSetting(YesNoState.NA) },
        { setRejectSynchronisationDetail("") },
        { setRejectDelaySetting("") },
        { setRejectDelayUnits("") },
        { setRejectDurationSetting("") },
        { setRejectDurationUnits("") },
        ...
        { setConveyorDetailsEngineerNotes("") },
        ...
        { setLinerCondition(ConditionState.NA) },
        { setLinerConditionComments("") },
        { setCablesCondition(ConditionState.NA) },
        { setCablesConditionComments("") },
        { setScrewsCondition(ConditionState.NA) },
        { setScrewsConditionComments("") },
        ...
        { setRejectConfirmSensorStopPosition("") },
        ...
        { setBackupSensorFitted(YesNoState.NA) },
        ...
        { setPackCheckSensorFitted(YesNoState.NA) },
        ...
        { setSpeedSensorFitted(YesNoState.NA) },
        ...
        { setOperatorTestResultLargeMetal("") },
        { setOperatorTestResultCertNumberFerrous("") },
        { setOperatorTestResultCertNumberNonFerrous("") },
        { setOperatorTestResultCertNumberStainless("") },
        { setOperatorTestResultCertNumberLargeMetal("") },
        { setSmeName("") },
        { setSmeEngineerNotes("") },
        { setDetectionSettingPvResult("") },
        { setFerrousTestPvResult("") },
        { setNonFerrousTestPvResult("") },
        { setStainlessTestPvResult("") },
        { setSmeTestPvResult("") },
        { setInfeedSensorTestPvResult("") },
        { setBinFullSensorTestPvResult("") },
        { setLargeMetalTestPvResult("") },
        ...
        { setBinDoorMonitorTestPvResult("") },
        { setDetectNotificationTestPvResult("") },

        { setSensitivityAsFoundFerrous("") },
        { setDetectRejectAsFoundFerrousLeading(YesNoState.NA)},
        { setDetectRejectAsFoundFerrousMiddle(YesNoState.NA) },
        { setDetectRejectAsFoundFerrousTrailing(YesNoState.NA) },
        { setPeakSignalAsFoundFerrousLeading("") },
        { setPeakSignalAsFoundFerrousMiddle("") },
        { setPeakSignalAsFoundFerrousTrailing("") },
        { setFerrousTestAsFoundEngineerNotes("") },

        { setSensitivityAsFoundNonFerrous("") },
        { setDetectRejectAsFoundNonFerrousLeading(YesNoState.NA)},
        { setDetectRejectAsFoundNonFerrousMiddle(YesNoState.NA) },
        { setDetectRejectAsFoundNonFerrousTrailing(YesNoState.NA) },
        { setPeakSignalAsFoundNonFerrousLeading("") },
        { setPeakSignalAsFoundNonFerrousMiddle("") },
        { setPeakSignalAsFoundNonFerrousTrailing("") },
        { setNonFerrousTestAsFoundEngineerNotes("") },

        { setSensitivityAsFoundStainless("") },
        { setDetectRejectAsFoundStainlessLeading(YesNoState.NA)},
        { setDetectRejectAsFoundStainlessMiddle(YesNoState.NA) },
        { setDetectRejectAsFoundStainlessTrailing(YesNoState.NA) },
        { setPeakSignalAsFoundStainlessLeading("") },
